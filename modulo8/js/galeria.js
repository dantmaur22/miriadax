var galeria = [
   ...
   { persona:"Jean Cocteau - Жан Кокто",
     frase:"Un vaso medio vacío de vino es también uno medio lleno, pero una mentiras a medias, de ningún modo es una media verdad.",
